...
const Hero =  function({ ref }) {
  ...
  const startups = [
    ...
    { id: 'knowtify', name: 'Knowtify', logo: logo, abbr: 'KN', link: 'https://knowtify.com', description: 'Knowtify is a early warning system that allows peopple evacuate from danger zones and .' }
  ];
